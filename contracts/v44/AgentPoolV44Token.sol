...
/// @notice Mainnet-candidate APOOL with no premint and no administrator.
///         A temporary deployment authority may wire exactly two immutable
///         emission lanes once. The authority is then irreversibly removed.
contract AgentPoolV44Token is ERC20, IAgentPoolV43Token {
